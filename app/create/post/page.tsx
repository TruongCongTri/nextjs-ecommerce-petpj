...
export default function CreatePostPage() {
  ...
  return (
    <Container>
      ...
      <div className="text-3xl font-bold mb-8 mx-auto">Create New Post </div>

      {/* <form className="max-w-3xl space-y-6 mx-auto" onSubmit={handleSubmit}> */}
      <form
        className="grid grid-cols-1 w-full lg:w-auto lg:grid-cols-[minmax(auto,256px)_minmax(720px,1fr)_minmax(auto,256px)] gap-6 lg:gap-12"
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            ...
            <Select onValueChange={(e) => setPostType(e)}>
              <SelectTrigger className="w-[180px]" disabled={isSubmitting || isCateLoading}>
