...
export default function ProductsFilterHeader({
  ...
  const handleValue = (e: string) => {
    ...
    router.push(
      `${siteConfig.proxy.shop}?${cateParamsList}&rating=${ratingParam}&priceStart=${priceStartParam}&priceEnd=${priceEndParam}&${tagParamsList}&sort=${e}&page=${DEFAULT_PAGE}&perPage=${DEFAULT_PER_PAGE}`
    );
  };
